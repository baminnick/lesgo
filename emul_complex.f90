...
#ifdef PPTLWMLES
public :: operator( .TLWMMULI. ), operator( .TLWMMULR. )
#endif
...
! REAL X REAL(COMPLEX) - for TLWM size arrays
interface operator (.TLWMMULR.)
    module procedure tlwm_mul_real_complex_real_2D
end interface
#endif
...
!******************************************************************************
function tlwm_mul_real_complex_real_2D( a, a_c ) result(b)
!******************************************************************************
!  This function emulates the multiplication of two complex 2D array by
!  emulating the input real array (a) as a complex type. This subroutine
!  ignores the imaginary part of a_c (e.g. would use this when imag(a_c)
...
end function tlwm_mul_real_complex_real_2D
#endif
