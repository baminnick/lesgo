...
#ifdef PPMFM
! REAL X IMAG(COMPLEX) - for GMT size arrays
interface operator (.GMTMULI.)
    module procedure gmt_mul_real_complex_imag_2D
end interface
#endif
...
#ifdef PPMFM
!******************************************************************************
function gmt_mul_real_complex_imag_2D( a, a_c ) result(b)
!******************************************************************************
!  This function emulates the multiplication of two complex 2D array by
!  emulating the input real array (a) as a complex type. This subroutine
!  ignores the real part of a_c (e.g. would use this when real(a_c) = 0)
...
end function gmt_mul_real_complex_imag_2D
#endif
